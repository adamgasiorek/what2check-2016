...
<html >
    ...
    <body >
        ...
        // LEWA STRONA
        include('uklad/lewastrona/album/album.php');
        //echo "adasko";
        include('szkielet/prawastrona.php');
        // PRAWA STRONA
        include('uklad/prawastrona/tab/album.php'); //album -- DO ZMIANY zaleznie od kategori

        include('szkielet/startsekcjitabs.php');

        include('uklad/prawastrona/tabssekcje/album.php'); //album -- DO ZMIANY zaleznie od kategori
        // KONIEC PRAWA STRONA
