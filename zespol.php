...
<html >
    ...
    <body >
        ...
        // PRAWA STRONA
        include('uklad/prawastrona/tab/zespol.php'); //zespol -- DO ZMIANY zaleznie od kategori

        include('szkielet/startsekcjitabs.php');

        include('uklad/prawastrona/tabssekcje/zespol.php'); //zespol -- DO ZMIANY zaleznie od kategori
        // KONIEC PRAWA STRONA
