...
(function (factory) {
    ...
    var Comments = {
        ...
        sortComments: function (comments, sortKey) {
            ...
            if(sortKey == 'popularity') {
                comments.sort(function(commentA, commentB) {
                    // UZWGLENIA ILOSC REPLY COMMENTOW
                    // var pointsOfA = commentA.childs.length;
                    // var pointsOfB = commentB.childs.length;

                    var pointsOfA = 0,pointsOfB = 0;
                    if(self.options.enableUpvoting) {
                        pointsOfA += parseInt(commentA.upvoteCount);
                        pointsOfB += parseInt(commentB.upvoteCount);
                    }
        ...
        textareaContentChanged: function(ev) {
            ...
            if(!textarea.find('.reply-to-badge').length) {
                ...
                // Case: new comment
                    ...
                    if (typeof textarea.parents('li.comment').last().data() != "undefined") {
                        var idkomm = textarea.parents('li.comment').last().data().model.idKom ;
                        console.log(idkomm)
                        textarea.attr('data-idKom', idkomm);
                    }
        ...
        upvoteComment: function(ev) {
            ...
            {
                var to = $(ev.currentTarget);
                var commentModel = to.parents('li.comment').first().data().model;
                var plusik;

                if(to.hasClass('positive') )
                {
                    to.removeClass('positive');
                    to.addClass('negative');
                    to.text(parseInt(to.text())-2);
                    plusik = -1;
                }
                else if(to.hasClass('negative') )
                {
                    to.removeClass('negative');
                    to.addClass('primary');
                    to.text(parseInt(to.text())+1);
                    plusik = 0;
                }
                else if(to.hasClass('primary') )
                {
                    to.removeClass('primary');
                    to.addClass('positive');
                    to.text(parseInt(to.text())+1);
                    plusik = 1;
                }
        ...
        createUpvoteElement: function(commentModel) {
            ...
            var upvoteEl = '<button class="upvote ui basic button ' + klasa + ' " style="position:' +
                ' relative;bottom: 5px;">'+commentModel.upvoteCount+'</button>';
        ...
        createCommentJSON: function(textarea) {
            ...
            var commentJSON = {
                ...
                parent: textarea.attr('data-parent') || null,
                idKom: textarea.attr('data-idKom') || null,
                created: time,
                modified: time,
                content: this.getTextareaContent(textarea),
        ...
        linkify: function(inputText) {
            ...
            // If there are hrefs in the original text, let's splitff
